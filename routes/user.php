...
Route::namespace ('App\Http\Controllers\User\Auth')->group(function () 
{
...
{
    //authorization
    Route::namespace ('App\Http\Controllers\User')->controller('AuthorizationController')->group(function () {
    ...
    Route::middleware(['check.status'])->namespace ('App\Http\Controllers\User')->group(function () 
    {
    ...
    // Payment
    Route::middleware(['check.status'])->namespace ('App\Http\Controllers')->group(function () 
    {
        Route::middleware('registration.complete')->prefix('deposit')->name('deposit.')
            ->controller('Gateway\PaymentController')->group(function () 
            {
