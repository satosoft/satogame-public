...
class RegisterController extends Controller {
    ...
    public function showRegistrationForm() {
        ...
        return view('templates.basic.user.auth.register', compact('pageTitle', 'mobileCode', 'countries'));
    }
    ...
    public function register(Request $request) 
    {
        ...
        Log::info('The value status in redirect path is'. $this->redirectPath());
        //Log::info('The value status in controller class is not existaha'. $this->redirectPath());
